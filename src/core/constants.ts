export const Constants = {
  Twitch: {
    CDN: (id: string, size: number) => `https://static-cdn.jtvnw.net/emoticons/v2/${id}/default/dark/${size + 1}.0`,
  },
  BTTV: {
    Global: "https://api.betterttv.net/3/cached/emotes/global",
    Channel: (id: number) => `https://api.betterttv.net/3/cached/users/twitch/${id}`,
    CDN: (id: string, size: number) => `https://cdn.betterttv.net/emote/${id}/${size + 1}x.webp`,
  },
  SevenTV: {
  ...
  FFZ: {
    ...
    Set: (id: number) => `https://api.frankerfacez.com/v1/set/${id}`,
    Channel: (id: number) => `https://api.frankerfacez.com/v1/room/id/${id}`,
